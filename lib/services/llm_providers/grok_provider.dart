  ...
  static Future<LLMResponse> call({
    ...
    try {
      ...
      if (response.statusCode != 200) {
        ...
        throw Exception(
          'Erro na API Grok: ${errorBody['error']?['message'] ?? response.statusCode}',
        );
      }
      ...
      if (choices.isEmpty) {
        throw Exception('Resposta vazia do Grok');
      }
      ...
      throw Exception('Erro ao chamar Grok: $e');
    }
  }
}
